...
const CreateQuiz = () => {
  ...
  const saveCorrectAnswer = async (index) => {
    ...
    const updatedQuestion = await updateQuestion(index, {
          ...
          <div className="border border-gray-700 rounded-lg mt-5 p-5 flex flex-col gap-3">
            <div className="flex flex-col md:flex-row md:items-center md:gap-3">
              <input
                ...
                className="flex-1 text-2xl bg-black border-b outline-none text-white p-2"
                        ...
                        {question.question_type === "multiple_choice" ? (
                          ...
                          <div className="flex flex-col gap-2">
                            {(question.options || []).map((opt, optIndex) => {
                              ...
                              const draft =
                                getDraftCorrectAnswer(question, index) || [];
                            ...
                            <button
                              onClick={() => saveCorrectAnswer(index)}
                              className="px-3 py-1 bg-blue-600 rounded text-white w-fit"
                            >
                              Save
                            </button>
                          </div>
                          ...
                          <div className="text-sm text-gray-400">
                            Dropdown questions do not have a correct answer.
                          </div>
                        ) : (
                          <div className="flex gap-2 items-center">
                            <input
